...
##Turned off all plotting scripts because I will instead summarize the data at the end and use the HZAR program to fit clines in order to better compare to empirical cline data which is not as clean and sigmoidal. 
...
ggsave("HZAM_HZAR_NuDNA_plot_Disp100%_100sims.png", plot = p, width = 5, height = 5)
#############################################
#############################################
#############################################
#############################################
