---
title: "RedFox_HZAR_Empiricalmodels"
...
#mtDNA <- read.table("mtDNA-summary.txt", header=T, stringsAsFactors=F) 
...
pdf("RedFox_hzarcline_mtDNA_tails_noCotton.right.pdf",6,6)
hzar.plot.fzCline(fit3_mtDNA_right,xlab="Geographic [South - North] Cline Distance (km)",ylab="Proportion of SVRF Ancestry (%)",main="RF.hzar.plot.cline(tails = right)")
...
0 -> hzar.meta.init(clineModel_none)$pMin
#Set initial pMax
0.9226 -> hzar.meta.init(clineModel_none)$pMax

#Set initial pMin
0 -> hzar.meta.init(clineModel_right)$pMin
#Set initial pMax
0.9226 -> hzar.meta.init(clineModel_right)$pMax

#Set initial pMin
0 -> hzar.meta.init(clineModel_left)$pMin
#Set initial pMax
0.9226 -> hzar.meta.init(clineModel_left)$pMax

#Set initial pMin
0 -> hzar.meta.init(clineModel_both)$pMin
#Set initial pMax
0.9226 -> hzar.meta.init(clineModel_both)$pMax

#Set initial pMin
0 -> hzar.meta.init(clineModel_mirror)$pMin
#Set initial pMax
0.9226 -> hzar.meta.init(clineModel_mirror)$pMax
...
#PDF graph version of top model
pdf("RedFox_hzarcline_nuDNA_tails_noCotton.none.updated20230409.pdf",6,6)
